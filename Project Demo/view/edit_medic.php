    ...
    if(isset($_POST['Update'])) 
{
        ...
        $query = mysqli_query($con, "UPDATE tbl_medteam SET teamName ='$teamName1', teamLeaderName ='$teamLeaderName1',teamLeadMobno ='$teamLeadMobno1',teamMembers ='$teamMembers1' WHERE ID = $teamid1");
    if($query){
    echo"UPDATED";
    }else{
        echo "Error";
...
$query=mysqli_query($con,"SELECT * from tbl_medteam WHERE ID='$teamid'");
while($row=mysqli_fetch_array($query)){
?>
...
<fieldset><legend><h2>Medical Team Creation</h2></legend>
        <form method ="post" action="" enctype="">
            ...
            <a href="manage_medic.php">Back</a>
        </form>    
</fieldset>
