...
Samsung SmartThings | CERTAIN PRODUCTS AND/OR THIRD-PARTY PRODUCTS MAY NOT WORK OR MAY CEASE TO WORK WITH SMARTTHINGS DESPITE SUPPORTING THE SAME STANDARDS. WE DO NOT PROVIDE ANY GUARANTEE OR WARRANTY OF COMPATIBILITY FOR THIRD-PARTY PRODUCTS, EVEN IF SUCH THIRD-PARTY PRODUCTS ARE ACCESSIBLE THROUGH SMARTTHINGS. PLEASE NOTE THAT IF YOU ADD MEMBERS, SUCH MEMBERS WILL HAVE FULL ACCESS AND CONTROL OVER ANY AND ALL OF YOUR CONNECTED PRODUCTS. IF YOU CHANGE THE REGISTERED COUNTRY OF YOUR SAMSUNG ACCOUNT, YOUR ACCOUNT WILL BE WITHDRAWN FROM SMARTTHINGS AND YOUR DATA IN THE SMARTTHINGS SERVER WILL BE DELETED. IN THIS CASE, YOU CAN SIGN UP BASED ON THE CHANGED REGISTERED COUNTRY AND USE SMARTTHINGS.
